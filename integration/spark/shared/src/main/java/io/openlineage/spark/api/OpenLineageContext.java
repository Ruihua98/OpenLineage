...
public class OpenLineageContext {
  ...
  /**
   * This application ParentRunFacet is attached to any events being emitted by runs. It's pointing
   * to wrapping run emitted by Spark integration onApplicationStart and completed onApplicationEnd.
   */
  @Getter @Setter OpenLineage.ParentRunFacet applicationParentFacet;
}
